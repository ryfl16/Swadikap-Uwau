...

{
    system("Color 1f");
    cout<<endl;
    string sambutan="\t\t>>>>>>>>>>SELAMAT DATANG DI ATM SWADIKAP UUUWWWAAAUUU<<<<<<<<<<\n\n";
    ...
    int pin=1234;
      cout<<"========================================================="<<endl;
      cout<<"||| SELAMAT DATANG DI ATM SWADIKAP UUUWWWAAAUUU       |||"<<endl;
    ...
    if (pin==1234)
   {
    ...
    else
    {
      ...
      cin >> pin;
        ...
        system("cls");
        cout<<"========================================================="<<endl;
        cout<<"|||            ATM SWADIKAP UUUWWWAAAUUU              |||"<<endl;
        cout<<"|||              PECAHAN RP 50000                     |||"<<endl;
        cout<<"=========================================================";
        cout<<"\n";
        cout<<"\tMENU : \n\n";
        ...
        case 1:
            {
                ...
                {
                cout<<"\n";
                cout<<"Terimakasih telah menggunakan ATM UWWWAUUUUUUUU";
                exit (0);
                }
                break;
            }
   ...
   else
   {
      while (!(saldo>=tf))
      {
        ...
        case 3:
            ...
            {
                cout<<"\n";
                cout << "Tarik Uang dengan pecahan RP 50000\n";
                cout<<"\n";
                cout<<"Coba Ulang y/n :";
                cin>>a;
        ...
        case 4:
            {
                ...
                char a;
                cout<<"========================================================="<<endl;
                cout<<"|||            ATM UWWWAUUU SWADIKAP                  |||"<<endl;
                cout<<"|||              PECAHAN RP 50000                     |||"<<endl;
                cout<<"=========================================================";
                cout<<"\n";
                cout<<" Setor Tunai \n";
                ...
                cin>>top;
                if (top%50000!=0 || top<0)
            {
                cout<<"\n";
                cout << "Setor Uang dengan pecahan RP 50000\n";
                cout<<"\n";
                cout<<"Coba Lagi y/n :";
                cin>>a;
                 if (a=='y'||a=='Y')
